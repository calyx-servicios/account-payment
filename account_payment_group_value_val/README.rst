=================================
Account Payment Value Validation
=================================
...
This module extends the functionality of account payment group and allows to configurate a 
validation in values of Supplier Payment and Partner Anticipe. 
...
#. Install Account Payment Group by ADOHC SA.
#. Install the module.

Usage
=====

#. Go to Account -> Account -> Configurations -> Check the option "Validate suppiler payments and partner anticipes"
