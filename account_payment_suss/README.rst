...
This module extends the functionality of Account Payment Group to support SUSS RG2682 Retention.
...
1. Accounting -> Purchases -> Purchable Products
2. Select any Product
3. Accounting Page -> Select a RG2682 Type (Engineering or Architecture)

Usage
=====

1. Invoice a Product with RG2682 Type Selected
2. At Payment (in case of exceed 1.5m AR$ in any RG2682 type) you will see an extra line of RG2682 Retention when the button Compute Withholdings is used.
